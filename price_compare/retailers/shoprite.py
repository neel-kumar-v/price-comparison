...
RETAILER = "ShopRite"
SEARCH_URL = "https://www.shoprite.com/sm/planning/rsid/139/results?q={query}"
...
def _set_zip(browser: AgentBrowser, zip_code: str) -> None:
    browser.tab_new(f"https://www.shoprite.com/?zip={zip_code}")
    time.sleep(3)


def fetch_shoprite_listing(browser: AgentBrowser, reference: ProductReference, zip_code: str = "19425") -> RetailerListing:
